...
export class migrations1731135420172 implements MigrationInterface {
    name = 'migrations1731135420172'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscription_status_enum" AS ENUM('Đang hoạt động', 'Không hoạt động', 'Đang chờ xử lý', 'Đã hủy', 'Đình chỉ', 'Hết hạn', 'Dùng thử', 'Quá hạn', 'Tạm dừng')`);
